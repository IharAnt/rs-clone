...
const ModalProduct = (product: IProduct) => {
  return (
    <div className="modal-product-container">
      ...
      <p className="modal-product-text modal-title">
        <span className="modal-product-text_bold">Название: </span>
        {product.title}
      </p>
      <p className="modal-product-text">
        <span className="modal-product-text_bold">Бренд: </span>
        {product.brand}
      </p>
      <p className="modal-product-text">
        <span className="modal-product-text_bold">Категория: </span>
        {product.category}
      </p>
      <p className="modal-product-text">
        <span className="modal-product-text_bold">Описание: </span>
        {product.description}
      </p>
      <div className="modal-product-text modal-product-price">
        <span className="modal-product-text_bold">Стоимость: </span>
        {product.price}
