...
import { optionSelectUser } from './types';
...
export const selectStyle: StylesConfig<MyOptionType | optionSelectUser, IsMulti> = {
...
export const selectStyleError: StylesConfig<MyOptionType | optionSelectUser, IsMulti> = {
  control: (provided, state) => {
    return {
      ...provided,
      ...customControlStyles,
