  ...
  return (
    <li className="achievements-container_item">
      ...
      <div>
        ...
        <p className="achievements-item_score">
          Для получения этого достижения необходимо набрать <span className="text-item-orange">{data.maxPoints}</span>{' '}
          баллов.
        </p>
        {scoreItem === 0 && <p className="achievements-item_score">У вас нету баллов за это достижение.</p>}
        {scoreItem > 0 && (
          <p className="achievements-item_score">
            Вы набрали: <span className="text-item-orange">{scoreItem}</span> баллов.
          </p>
        )}
      </div>
    </li>
